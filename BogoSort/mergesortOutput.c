...
int main(){
    ...
    while(1){
        ...
        mergeSort(unsortedArray, 0, numbersOfElements - 1, &countElementsSwitched, &countsArrayChecked);
        printf("After \033[31m%zu\033[0m Swaps and \033[31m%zu\033[0m Array Checkes (Merge Sort): \n", countElementsSwitched, countsArrayChecked);
        for (size_t i = 0; i < numbersOfElements; i++)
        {
            printf("%.2f ", unsortedArray[i]);
        }
