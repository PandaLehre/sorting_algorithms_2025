...
int main(){
    ...
    while(1){
        ...
        bubbleSort(unsortedArray, numbersOfElements, &countElementsSwitched, &countsArrayChecked);
        printf("After \033[31m%zu\033[0m Swaps and \033[31m%zu\033[0m Array Checkes (Bubble Sort): \n", countElementsSwitched, countsArrayChecked);
        for (size_t i = 0; i < numbersOfElements; i++)
        {
            printf("%.2f ", unsortedArray[i]);
        }
